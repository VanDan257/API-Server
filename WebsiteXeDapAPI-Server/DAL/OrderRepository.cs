...
namespace DAL
{
    public class OrderRepository : IOrderRepository
    {
        ...
        public async Task<bool> UpdateStatusOrder(OrderStatusUpdateRequest model)
        {
            string msgError = "";
            try
            {
                var result = _context.ExecuteScalarSProcedureWithTransaction(out msgError, "update_status_order",
                    "@OrdID", model.OrdID,
                    "@Status", model.Status);
